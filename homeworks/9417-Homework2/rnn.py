...
if __name__ == '__main__':
    model = NeuralNetwork()
    training_input = read_data("datasets/datasets/training_input.txt", encode_string, 9)
    training_label = read_data("datasets/datasets/training_label.txt", one_hot_encode_character, 1)
